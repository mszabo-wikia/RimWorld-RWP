...
{
    /// <summary>
    /// Optimized <see cref="RimWorld.WorkGiver_TendOtherUrgent"/> implementation that only scans patients who are in bed.
    /// </summary>
    public class WorkGiver_TendOtherUrgent : RimWorld.WorkGiver_TendOtherUrgent
    {
